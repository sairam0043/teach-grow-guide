            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 text-muted-foreground">
                  ...
                  <span>support@cuvasol.com</span>
                </div>
                <div className="flex items-center gap-3 text-muted-foreground">
                  <Phone className="h-5 w-5 text-primary" />
                  <span>+91 9538517963</span>
                </div>
                <div className="flex items-center gap-3 text-muted-foreground">
                  <MapPin className="h-5 w-5 text-primary" />
                  <span>HD-169, We Work, 78 Old Madras Road, Salarpuria Magnifica, Tin Factory, Mahadevapura, Bangalore 560016</span>
                </div>
              </div>
            </div>
